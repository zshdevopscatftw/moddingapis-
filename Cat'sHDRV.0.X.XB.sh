...
echo "  🐱 CAT'S TWEAKER v3.5.6 loaded!"
ENV
chmod +x "$INSTALL_DIR/env.sh"; ok "env.sh"
add_path ""; add_path "# Cat's Tweaker v3.5.6"; add_path "source \"$INSTALL_DIR/env.sh\" 2>/dev/null"
...
echo ""
printf "${G}╔═════════════════════════════════════════════════════════════════════╗${RST}\n"
printf "${G}║${RST}  ${W}✨ CAT'S TWEAKER v3.5.6 COMPLETE! ✨${RST}                             ${G}║${RST}\n"
